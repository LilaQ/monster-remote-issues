...
- **Account information:** A private Sign in with Apple account identifier and, when you provide it, a display name. Monster Remote never receives your Apple password. The stable Apple account identifier is retained only as a one-way hash. Apple email and private-relay email values are not stored by Monster Remote Intelligence.
